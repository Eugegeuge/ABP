...
\begin{enumerate}
    \item \textbf{Preparación del Entorno (Workspace)}: Una vez clonados los paquetes (\texttt{uav\_gazebo}, \texttt{uav\_description}, \texttt{uav\_control}, \texttt{uav\_vision}), se deberá compilar el entorno completo.
    \begin{verbatim}
cd ~/Documents/abp
